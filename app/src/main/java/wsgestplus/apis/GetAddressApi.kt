...
import com.microplus.wsGestplus.infrastructure.MultiValueMap
...
import com.microplus.wsGestplus.models.Address

class GetAddressApi(basePath: kotlin.String = "/") : ApiClient(basePath) {
    ...
    fun getAddress(obj: kotlin.String? = null): Address {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (obj != null) {
                put("obj", listOf(obj.toString()))
            }
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/getAddress", query = localVariableQuery
        )

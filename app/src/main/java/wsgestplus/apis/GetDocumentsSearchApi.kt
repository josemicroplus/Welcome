...
import com.microplus.wsGestplus.models.DocumentsSearch
import com.microplus.wsGestplus.models.ResultDocumentSearch

class GetDocumentsSearchApi(basePath: kotlin.String = "/") : ApiClient(basePath) {

    /**
     * 
     * 
     * @param body  (optional)
     * @return ResultDocumentSearch
     */
    @Suppress("UNCHECKED_CAST")
    fun getDocumentsSearch(body: DocumentsSearch? = null): ResultDocumentSearch {
        val localVariableBody: kotlin.Any? = body
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/getDocumentsSearch"
        )
        val response = request<ResultDocumentSearch>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as ResultDocumentSearch
